  ...
  return new Promise((resolve) => resolve(null)).then(() => [
    {
      ...
      name: 'DS스토어 모더니제이션',
      description: '기존 동아사이언스 쇼핑몰 시스템을 MSA 기반으로 재개발 하는 프로젝트로, Next.js 기반 반응형 웹 / 어드민 웹의 개선 및 추가 기능 개발 진행 후 서비스 오픈 경험',
    ...
    },
    {
      ...
      name: 'SKON 배터리 아카데미',
      description: 'SKON 배터리 직원을 대상으로한 다국어 지원 사내 아카데미 서비스 개발 프로젝트로, 강의 시청 및 관리를 위한 주요 페이지 등을 개발하여 서비스 오픈 및 운영 경험',
    ...
    },
    {
      ...
      description: '한국관광공사에 등록된 50만건 이상의 관광정보를 통합 관리 및 이용을 위한 시스템 개발 프로젝트로, Next.js기반 반응형 웹 / 어드민 웹 개발 참여 후 서비스 오픈 경험',
    ...
    },
    {
      ...
      name: 'GS 홈쇼핑 모더니제이션',
      description: '기존 홈쇼핑 시스템을  MSA 기반으로 재개발하는 프로젝트, 중간에 투입되어 추가 기능 개발을 지원',
    ...
    },
    {
      ...
      tags: ['React', 'Typescript', 'Rollup', 'Next.js', 'MobX', 'Storybook'],
      name: '나라 플랫폼 2.0',
      description: '다양한 프로젝트에서 공통된 도메인 및 기능 제공을 위한 사내 서비스로, 도메인 변경으로 인한 리팩토링 및 버전업 진행',
