...
export function ResumeProject() {
  ...
  const data: ProjectCardModel[] = [
    ...
    },
    {
      ...
      name: '한국관광공사 관광정보 관리 시스템(Conlab)',
    ...
    },
    {
      ...
      name: '나무소리',
      desc: '5년간 1만 7천여명의 재직자를 대상으로 진행된 사내 코칭 서비스로, 시험 및 통계 기능 추가 개발을 진행하였습니다.',
  ...
  return (
    <section className="section-wrapper" id={id}>
      <div className="project-wrap">
        ...
        {data.map((value) => (
          <ProjectCard key={value.key} projectData={value} />
        ))}
      </div>
    </section>
  );
